...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(MResource.getIdByName(this.mContext,"layout","video_trimmer_view"), this, true);

        mLinearVideo = (RelativeLayout)findViewById(MResource.getIdByName(this.mContext,"id","layout_surface_view") );
        mVideoView = (VideoView)findViewById(MResource.getIdByName(this.mContext,"id","video_loader")   );
        mPlayView = (ImageView)findViewById(MResource.getIdByName(this.mContext,"id","icon_video_play")   );
        mSeekBarLayout =(LinearLayout) findViewById(MResource.getIdByName(this.mContext,"id","seekBarLayout")     );
        mRedProgressIcon = (ImageView)findViewById( MResource.getIdByName(this.mContext,"id","positionIcon") );
        mVideoShootTipTv =(TextView) findViewById( MResource.getIdByName(this.mContext,"id","video_shoot_tip")  );
        mVideoThumbRecyclerView =(RecyclerView) findViewById(MResource.getIdByName(this.mContext,"id","video_frames_recyclerView") );
    ...
    public void initVideoByURI(final Uri videoURI) {
        ...
        mVideoShootTipTv.setText(String.format(mContext.getResources().getString( MResource.getIdByName(this.mContext,"string","video_shoot_tip")  ), TrimVideoUtil.VIDEO_MAX_TIME));
    }
    ...
    private void setUpListeners() {
        findViewById(MResource.getIdByName(this.mContext,"id","cancelBtn")     ).setOnClickListener(new OnClickListener() {
            @Override
        ...
        findViewById(MResource.getIdByName(this.mContext,"id","finishBtn")        ).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                onSaveClicked();
            }
    ...
    private void setPlayPauseViewIcon(boolean isPlaying) {
        mPlayView.setImageResource(isPlaying ?   MResource.getIdByName(this.mContext,"drawable","icon_video_pause_black")   :  MResource.getIdByName(this.mContext,"drawable","icon_video_play_black") );
    }
    ...
    private void playingAnimation() {
        ...
        mRedProgressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                params.leftMargin = Integer.valueOf(String.valueOf(animation.getAnimatedValue()));
